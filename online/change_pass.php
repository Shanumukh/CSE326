...
Current Password :
<input type="password" name="cpassword" value=""  style="color:#000;">
<br>
<br>
New Password:
<input type="password" name="npassword" value=""  style="color:#000;">
<br>
<br>
Confirm New Password:
<input type="password" name="cnpassword" value=""  style="color:#000;">
<br>
<br>
<input type="submit" name="cpass" value="UPDATE"  style="color:black;" >
</form></center>
